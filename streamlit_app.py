...
def main():
    ...
    st.markdown("Thermal image of bison for classification.")
...
def load_model():
    ...
    if plt == 'Linux' or plt == 'Darwin': pathlib.WindowsPath = pathlib.PosixPath
    inf_model = load_learner('bison_sex_AI_v1.pkl', cpu=True)
...
EXTERNAL_DEPENDENCIES = {
    "bison_sex_AI_v1.pkl": {
        "url": "https://drive.google.com/file/d/1lhu3lwg0l30fdD0imNMmyG0NsZLMKYpp/view?usp=share_link",
        "size": 179194997
    }
}
